...
//All Movie Request
$movies = $client->request('GET', 'https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1', [
    'headers' => [
...
// $poster = "https://image.tmdb.org/t/p/w500/".$data_res['poster_path'];
                ...
                <div class="action">
                    ...
                    <?php foreach($data_res as $d): ?>
                        <?php if(in_array('28',$d['genre_ids']) ) : ?>
                            <img src=<?="https://image.tmdb.org/t/p/w500/".$d['poster_path'];?> alt="">
                            <?php endif; ?>
                        <?php endforeach; ?>
                </div>
                <div class="comedy">
